	...
	<main class="main margin-bottom">
		<section class="align_column col_5 margin_left">
			...
			<article class="margin-top-1">
				<h2>Informations</h2>
				<p>
					Prévoir un pique-nique et bouteilles d'eau. Les randonnées avec retour le lendemain inclus une nuit dans un gîte et un petit-déjeuner pour un supplément de <b>20€</b> par personnes.
				</p>
			</article>
		</section>
		<aside>
